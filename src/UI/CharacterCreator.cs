...
public static class CharacterCreator
{
    ...
    public static Stats ChooseStats()
    {
        ...
        CurTop =
            "It is now time for you to determine the numbers of your characteristics.\nYou have a total of 7 points to spend on 5 different characteristics.\n\n";
        ...
        while (true)
        {
            ...
            if (Step == 0)
            {
                ...
                if (
                    Num.Equals("")
                    || !CharacterCreator.IsNum(Num)
                    || Int32.Parse(Num) > RemainingPoints
                )
                {
                    Console.Clear();
            ...
            else if (Step == 5)
            {
                ...
                {
                    Console.WriteLine(
                        "\nYou still have {0} unspent point{1}",
                        RemainingPoints,
                        (RemainingPoints > 1 ? "s" : "")
                    );
                    while (true)
