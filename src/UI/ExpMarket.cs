...
public class ExpMarket
{
    ...
    private string ParseCommand(string Raw)
    {
        ...
        if (Raw.Equals("1") || Raw.Equals("characteristics") || Raw.Equals("buy characteristics"))
            return "characteristics";
        else if (Raw.Equals("2") || Raw.Equals("exchange") || Raw.Equals("exchange for gold"))
            return "exchange";
        else if (Raw.Equals("3") || Raw.Equals("spells") || Raw.Equals("buy spells"))
            return "spells";
    ...
    private void ExchangeExp()
    {
        ...
        while (true)
        {
            ...
            Console.WriteLine(
                "How many experience points do you want to trade: (Type ENTER on empty number to return)"
            );
