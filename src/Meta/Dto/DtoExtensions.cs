...
public static class DtoExtensions
{
    ...
    public static EquipmentDto ToDto(this Equipment equipment)
    {
        ...
        {
            Head = equipment.Head?.ToDto() ?? null,
            Torso = equipment.Torso?.ToDto() ?? null,
            Leg = equipment.Leg?.ToDto() ?? null,
            Hand = equipment.Hand?.ToDto() ?? null,
    ...
    {
        return new BagDto { Gold = bag.Gold, Items = bag.Items.Select(x => x.ToDto()).ToArray() };
    }
